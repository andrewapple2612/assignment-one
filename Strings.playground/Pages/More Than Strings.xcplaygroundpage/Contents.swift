...
let adjective = "metalic"
let noun = "bike"
let place = "store"
let positiveEmotion = "happy"
let negativeEmotion = "sad"
let story = "Today was a big day for \(goalieName). They had finally saved up \(firstHalfSaves) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were out of \(noun)."
